...
local suite = chrono.suite("list.cartesian_iter_copy", { iterations = ITERATIONS_HEAVY, warmup = 100 })
...
suite:add("cartesian_iter_copy 2x2 (4)", function()
  for _ in cartesian_iter_copy(cart_small) do end
end)

suite:add("cartesian_iter_copy 3x3x2 (18)", function()
  for _ in cartesian_iter_copy(cart_medium) do end
end)

suite:add("cartesian_iter_copy 4x4x2x2 (64)", function()
  for _ in cartesian_iter_copy(cart_large) do end
end)
